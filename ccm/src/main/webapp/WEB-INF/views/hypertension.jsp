...
<body>
	...
	<div class="jumbotron">
		<div class="container">
			...
			<c:url var="saveCondition" value="/saveHypertension">
				<c:param name="cond" value="Hypertension"></c:param>
			...
			<c:url var="getConditionHist" value="/getConditionHistory">
				<c:param name="condition" value="Hypertension"></c:param>
				<c:param name="patientId" value="${patientId}"></c:param>
				<c:param name="pageString" value="${pageString}"></c:param>
			</c:url>
			<form:form action="${saveCondition }" modelAttribute="ht">
				...
				<table style="width: 100%">
					...
					<tr>
						<td>Headache</td>
						<td><div>
								<form:radiobutton path="headache" label="Yes" value="true" />

								<form:radiobutton path="headache" label="No" value="false" />

							</div></td>
						<td><form:textarea path="headacheComments"
								placeholder="Additional Information" rows="3" cols="40" /></td>
					</tr>
					<tr>
						<td>Fatigue</td>
					...
					<tr>
						...
						<td><form:input path="weightGainCurrent"
								placeholder="Current Weight" style="width: 125px;" /> Past
							weight: <form:input path="weightGainPrevious"
								style="width: 125px;" placeholder="AutoPopulated" /></td>
					</tr>
